...
public class Tel extends HttpServlet {
		...
		/*String phone="15702976609";*/
		   Mysqls my=new Mysqls();
	        ...
	        System.out.println("验证码已经发到您的手机号"+phone+"请注意查收");
		    	 ...
		    	 response.getWriter().write("tel_repeat");
	...
	NameValuePair[] data ={ new NameValuePair("Uid", "wangxufeng0"),new NameValuePair("Key", "1dba91f32961c84a046f"),new NameValuePair("smsMob",tel),new NameValuePair("smsText","欢迎注册学习规划系统,您的验证码为:"+num)};
